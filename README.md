...
- Model predictions paired with explainability (SHAP) instead of opaque outputs
...
|---|---|
| [Portfolio Site](https://github.com/Jayaram-49/jayaram-portfolio) | Personal site built for speed (Lighthouse 95+), not just looks |
